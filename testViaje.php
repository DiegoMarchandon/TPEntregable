...
$responsable1 = new ResponsableV(9990, 540540, "gerardo manuel");
...
$responsable2 = new ResponsableV(1200, 780010, "blas campos");
...
function cargarNuevoViaje(){
    ...
    $respViaje = new ResponsableV($nroEmpleado, $nroLicencia, $nombreYapellido);
    $i = 0;
    while($i < $cantMax){
